import { isObject } from '@mmo/shared';
import {
  ZodObject,
  type input,
  type output,
...
// @FIXME this is a copy/paste of the @vee-validate/zod because it fails during testing for some reason...
// No idea why an `schema instanceof zod.ZodObject` fails...
